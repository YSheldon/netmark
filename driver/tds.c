...
#define LINKNAME_STRING     L"\\DosDevices\\TDS"
// #define NTDEVICE_STRING     L"\\Device\\Passthru"
#define NTDEVICE_STRING     L"\\Device\\TDS"
...
--*/
{
    ...
    do
    {
        ...
        MChars.MajorNdisVersion = TDS_MAJOR_NDIS_VERSION;
		// MChars.MinorNdisVersion = PASSTHRU_MINOR_NDIS_VERSION;
        MChars.MinorNdisVersion = TDS_MINOR_NDIS_VERSION;
        ...
        PChars.MajorNdisVersion = TDS_PROT_MAJOR_NDIS_VERSION;
		// PChars.MinorNdisVersion = PASSTHRU_PROT_MINOR_NDIS_VERSION;
        PChars.MinorNdisVersion = TDS_PROT_MINOR_NDIS_VERSION;
        ...
        NdisInitUnicodeString(&Name, L"TDS");    // Protocol name
        PChars.Name = Name;
...
//    DBGPRINT(("<== TDSDeregisterDevice: %x\n", Status));
    return Status;
