...
#define TDS_MAJOR_NDIS_VERSION            5
// #define PASSTHRU_MINOR_NDIS_VERSION            1
#define TDS_MINOR_NDIS_VERSION            1
#else
// #define PASSTHRU_MAJOR_NDIS_VERSION            4
#define TDS_MAJOR_NDIS_VERSION            4
// #define PASSTHRU_MINOR_NDIS_VERSION            0
#define TDS_MINOR_NDIS_VERSION            0
#endif

#ifdef NDIS51
// #define PASSTHRU_PROT_MAJOR_NDIS_VERSION    5
#define TDS_PROT_MAJOR_NDIS_VERSION    5
// #define PASSTHRU_PROT_MINOR_NDIS_VERSION    0
#define TDS_PROT_MINOR_NDIS_VERSION    0
#else
// #define PASSTHRU_PROT_MAJOR_NDIS_VERSION    4
#define TDS_PROT_MAJOR_NDIS_VERSION    4
// #define PASSTHRU_PROT_MINOR_NDIS_VERSION    0
#define TDS_PROT_MINOR_NDIS_VERSION    0
#endif
...
} TDSS_EVENT_CODE, *PTDS_EVENT_CODE; 
...
typedef struct _TDS_EVENT
{
    NDIS_EVENT Event;
// PASSSTHRU_EVENT_CODE_EVENT_CODE Code;
    TDSS_EVENT_CODE Code;

// } PASSTHRU_EVENT, *PPASSTHRU_EVENT;
} TDS_EVENT, *PTDS_EVENT;
